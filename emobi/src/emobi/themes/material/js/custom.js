...
$(document).ready(function () {
	...
	// Alert auto close
	$('.myadmin-alert').fadeIn().addClass('animated fadeInUp');
	setTimeout(function() {
	   $('.myadmin-alert').removeClass('fadeInUp').addClass('fadeOutDown');
	}, 7000);
