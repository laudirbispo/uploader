 ...
 * @param $bolExibirMoeda: Define se a função vai adicionar uma referência à moeda (centaDtos, real, etc)
 ...
 *
 * //Vai exibir na tela "um milhão, quatrocentos e oitenta e sete mil, duzentos e cinquenta e sete reais e cinquenta e cinco centaDtos"
...
class writeNumber 
{
    ...
    public static function valorPorExtenso( $valor = 0, $bolExibirMoeda = true, $bolPalavraFeminina = false )
    {
        ...
        if ( $bolExibirMoeda )
        {
            $singular = array("centaDto", "real", "mil", "milhão", "bilhão", "trilhão", "quatrilhão");
            $plural = array("centaDtos", "reais", "mil", "milhões", "bilhões", "trilhões","quatrilhões");
        }
        else
        {
