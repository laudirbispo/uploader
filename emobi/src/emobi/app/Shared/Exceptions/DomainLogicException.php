...
class DomainLogicException extends \Exception implements CustomizableException
{
	...
	public function saveLog (string $channel = 'LOGIC', string $level = 'CRITICAL') 
	{
