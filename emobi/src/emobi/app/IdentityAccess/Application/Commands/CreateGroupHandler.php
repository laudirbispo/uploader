...
use app\IdentityAccess\Domain\Models\{UserId, GroupId, GroupName, GroupDescription, GroupStatus};
...
final class CreateGroupHandler 
{
	...
	public function handler(CreateGroupCommand $Command) : Group
	{
		$Group = Group::create(
			GroupId::generate(),
		...
		$this->userRepository->save($Group);
		return $Group;
	}
}
