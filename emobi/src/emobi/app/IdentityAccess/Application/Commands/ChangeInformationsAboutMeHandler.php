...
use app\IdentityAccess\Domain\Models\{UserId, Name, Gender};

final class ChangeInformationsAboutMeHandler
{
    ...
    public function handler(ChangeInformationsAboutMeCommand $Command)
    {
