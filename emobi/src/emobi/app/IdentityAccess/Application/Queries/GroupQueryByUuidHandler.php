...
final class GroupQueryByUuidHandler 
{
	...
	public function handler(GroupQueryByUuid $GroupQueryByUuid)
	{
		$GroupId = new GroupId($GroupQueryByUuid->getUuid());
		return $this->userQueryRepository->getGroupByUuid($GroupId->get());
	}
}