...
class FlashMessages {
    ...
    protected $msgWrapper = "<div id='alertbottomleft' style='z-index: 99999;' class='alert myadmin-alert myadmin-alert-bottom-left %s'>%s <h4>%s</h4>%s</div>\n"; 
     ...
     * 
     */
    public function info(string $message, string $redirectUrl = '', bool $sticky = false)
    {
     ...
     * 
     */
    public function notice(string $message, string $redirectUrl = '', bool $sticky = false)
    {
        return $this->add($message, self::NOTICE, $redirectUrl, $sticky);
    }
     ...
     * 
     */
    public function success(string $message, string $redirectUrl = '', bool $sticky = false)
    {
     ...
     * 
     */
    public function warning(string $message, string $redirectUrl = '', bool $sticky = false)
    {
     ...
     * 
     */
    public function error(string $message, string $redirectUrl = '', bool $sticky = false)
    {
     ...
     * 
     */
    public function sticky(string $message, string $redirectUrl = '', bool $sticky = false)
    {   
					   ...
					   ) 
    {
        ...
        $_SESSION['flash_messages'][$type][] = ['sticky' => $sticky, 'message' => nl2br($message)];
    ...
    protected function formatMessage($msgDataArray, $type)
    {
        ...
        $formattedMessage = $msgDataArray['message'] . $this->msgAfter; 
