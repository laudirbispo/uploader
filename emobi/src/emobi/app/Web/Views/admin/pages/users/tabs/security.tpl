<div class="col-md-8">
<form action="/admin/account/security" method="post" enctype="application/x-www-form-urlencoded" data-toggle="validator" novalidate="true" class="form-material">
    ...
    <div class="form-group">
        <button type="submit" name="submit-form" value="update-password" class="btn btn-info waves-effect waves-light">SALVAR</button>
    </div>
</form>
</div>
